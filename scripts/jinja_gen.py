...
if __name__ == "__main__":
    ...
    parser.add_argument('--camNamespace',type=str, default="", help="Drone namespace")
    ...
    # parser.add_argument('--gst_udp_port', default=5600, help="UDP port for video streaming")
    # parser.add_argument('--gst_udp_port_thermal', default=5620, help="UDP port for video streaming thermal")
